...
const dietPlanDefaults = {
  breakfast: [
    {
      title: "Oats & Berries",
      desc: "320 kcal • High Fiber",
      image:
        "https://images.unsplash.com/photo-1591535102082-a3fe217ef1bd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
    {
      title: "Spinach Omelette",
      desc: "280 kcal • Protein Rich",
      image:
        "https://images.unsplash.com/photo-1631182661308-c2c81d4e08b4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
  ],
  lunch: [
    {
      title: "Chicken & Rice",
      desc: "450 kcal • Balanced",
      image:
        "https://images.unsplash.com/photo-1762631934518-f75e233413ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
    {
      title: "Fish & Quinoa",
      desc: "410 kcal • Omega-3",
      image:
        "https://images.unsplash.com/photo-1704007573697-6a516da421ec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
  ],
  snack: [
    {
      title: "Mixed Nuts",
      desc: "180 kcal • Healthy Fats",
      image:
        "https://images.unsplash.com/photo-1671981200629-014c03829abb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
    {
      title: "Fresh Fruit Bowl",
      desc: "120 kcal • Vitamins",
      image:
        "https://images.unsplash.com/photo-1588068403046-169c80c69938?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
  ],
  dinner: [
    {
      ...
      desc: "210 kcal • Light",
      image:
        "https://images.unsplash.com/photo-1643786661490-966f1877effa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
    {
      title: "Chicken Salad",
      desc: "340 kcal • Low Carb",
      image:
        "https://images.unsplash.com/photo-1604909052743-94e838986d24?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
    },
  ],
};
...
const healthTipsDefaults = [
  {
    ...
    desc: "Aim for 5 days a week of mixed cardio and strength training.",
    image:
      "https://images.unsplash.com/photo-1771586791190-97ed536c54af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
  },
  {
    title: "Prioritize Sleep",
    desc: "Get 7-8 hours nightly to reduce inflammation and boost recovery.",
    image:
      "https://images.unsplash.com/photo-1631312113214-8f2f03a6962f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
  },
  {
    title: "Manage Stress",
    desc: "Practice daily yoga or meditation to keep cortisol levels in check.",
    image:
      "https://images.unsplash.com/photo-1621691223255-b89d5623df3a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
  },
  {
    title: "Stay Hydrated",
    desc: "Drink at least 8 glasses of water to maintain metabolic balance.",
    image:
      "https://images.unsplash.com/photo-1555704574-a9cfdfab06e0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
  },
];
...
export default function ReportAnalysisMobile() {
  ...
  const { addPendingAnalysis, pendingAnalysisIds, dataRefreshTrigger } =
    useData();
    ...
    const fetchReport = async () => {
      try {
        ...
        if (error.response?.status === 404) {
          toast.error(
            "Report analysis failed because the uploaded file is not a valid medical report.",
          );
          navigate("/reports", { replace: true });
          return;
        }
  ...
  const renderMarkdown = (text) => {
    ...
    return parts.map((part, i) => {
      if (part.startsWith("**") && part.endsWith("**")) {
        return (
          <span key={i} className="text-emerald-400 font-black">
            {part.slice(2, -2)}
          </span>
        );
      }
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-[#F2F5EC]">
        <div className="text-center">
          ...
          <p className="text-[#69A38D] font-black uppercase tracking-widest text-xs">
            Loading Synthesis...
          </p>
        </div>
      </div>
    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-[#F2F5EC] px-6">
        ...
        <button
          ...
          className="px-8 py-3 bg-[#69A38D] text-white font-bold rounded-full"
        >
          Back to AI Analyzer
        </button>
      </div>
        ...
        <div className="flex flex-col items-center gap-8 relative z-10 text-center">
          <div className="relative">
            <div className="w-24 h-24 rounded-[32px] bg-white shadow-2xl flex items-center justify-center border border-white relative z-20">
              <Clock
                size={40}
                className="text-[#69A38D] animate-[spin_5s_linear_infinite]"
              />
            </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[15px] font-bold text-slate-500 leading-relaxed max-w-[280px] mx-auto">
              Our medical AI is currently reading your bio-markers. This usually
              takes <span className="text-[#69A38D]">1-2 minutes</span>.
            </p>
          </div>

          <div className="w-full max-w-[300px] h-3 bg-white rounded-full p-1 border border-white shadow-inner">
            <div
              className="h-full bg-gradient-to-r from-[#69A38D] to-[#8BC34A] rounded-full animate-[progress_15s_ease-in-out_infinite]"
              style={{ width: "45%" }}
            ></div>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-xl rounded-[40px] p-8 border border-white shadow-xl mt-8 w-full group">
            ...
            <h2 className="text-lg font-black text-[#1a2138] mb-3 uppercase tracking-tight">
              While you wait...
            </h2>
            <p className="text-sm font-bold text-slate-600 mb-8 leading-relaxed">
              Take a quick platform tour to see how our AI can help you
  ...
  const metrics = Object.entries(aiAnalysis?.metrics || {}).map(
    ([name, data]) => ({
      name,
      value: typeof data === "object" ? data.value : data,
      unit: typeof data === "object" ? data.unit : "",
      status:
        (typeof data === "object" ? data.status?.toUpperCase() : "NORMAL") ||
        "NORMAL",
      normalRange:
        typeof data === "object" ? data.normalRange || data.range : "",
  ...
  const filteredMetrics = metrics.filter((m) => {
    ...
    return (
      m.status === metricTab.toUpperCase() ||
      (metricTab === "Borderline" && m.status === "MODERATE")
    );
  });

  const normalCount = metrics.filter(
    (m) => m.status === "NORMAL" || m.status === "GOOD",
  ).length;
  ...
  const highCount = metrics.filter(
    (m) =>
      m.status === "HIGH" || m.status === "CRITICAL" || m.status === "ABNORMAL",
  ).length;

  return (
    <div
      id="report-mobile-content"
      className="min-h-screen bg-gradient-to-b from-[#F2F5EC] to-[#E5EBE0] dark:from-[#161719] dark:to-[#161719] pb-32 relative overflow-x-hidden"
    >
      <SEO pageName="report" />
      ...
      <div className="px-6 pt-12 pb-6 flex items-center justify-between sticky top-0 bg-[#F2F5EC]/80 dark:bg-[#161719]/80 backdrop-blur-md z-50 border-b border-white/50">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-[20px] font-black text-[#1a2138] dark:text-white tracking-tight leading-none uppercase">
            {isHindi ? "रिपोर्ट विश्लेषण" : "Clinical Synthesis"}
          </h1>
          <p className="text-[10px] text-[#69A38D] font-black uppercase tracking-widest mt-1">
            AI-Powered Insights
          </p>
        </div>
        <div className="flex gap-2 no-pdf">
          ...
          <button
            ...
            className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${isHindi ? "bg-[#69A38D] text-white" : "bg-white shadow-sm text-[#69A38D]"}`}
          >
            <Languages size={15} />
          </button>
          <button
            onClick={handleShare}
            className="w-8 h-8 bg-white shadow-sm rounded-full flex items-center justify-center text-[#1a2138]"
          >
            <Share2 size={15} />
          </button>
          <button
      ...
      <div className="px-5 flex flex-col gap-5 relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-[#64748b] uppercase tracking-widest mb-0.5">
                  {isHindi ? "रिपोर्ट प्रकार" : "Diagnostic Profile"}
                </span>
                <span className="text-[18px] font-black text-[#1a2138] uppercase tracking-tight leading-none">
                  {report.reportType}
                </span>
              </div>
            </div>
            <div
              className={`flex items-center gap-1.5 px-4 py-2 ${isProcessing ? "bg-amber-50 text-amber-600 border-amber-100" : "bg-[#69A38D]/10 text-[#69A38D] border-[#69A38D]/20"}  rounded-full border shadow-sm`}
            >
              <div
                className={`w-1.5 h-1.5 rounded-full ${isProcessing ? "bg-amber-500 animate-pulse" : "bg-[#69A38D]"}`}
              ></div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-2 text-[#1a2138]">
                ...
                <span className="text-[14px] font-black uppercase tracking-tight">
                  {report.patientName || "Clinical Record"}
                </span>
              </div>
            </div>
            <div className="flex flex-col gap-1 text-right">
              <span className="text-[10px] font-black text-[#64748b] uppercase tracking-widest">
                {isHindi ? "तारीख" : "Timeline"}
              </span>
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-[40px] p-6 shadow-[0_4px_25px_rgba(0,0,0,0.04)] border border-white">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className="flex flex-col">
              <h2 className="text-[20px] font-black text-[#1a2138] uppercase tracking-tight">
                {isProcessing
                  ? "Extracting Data"
                  : isHindi
                    ? "डॉक्टर का विश्लेषण"
              ...
              {!isProcessing && (
                <p className="text-[10px] font-black text-[#69A38D] uppercase tracking-widest">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-gradient-to-br from-[#f0f7f4] to-white dark:from-white/5 dark:to-white/10 rounded-[35px] p-8 border border-[#69A38D]/20 shadow-sm relative overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="text-[14px] font-black text-[#69A38D] uppercase tracking-widest leading-none mb-1.5">
                    {isHindi ? "डॉक्टर की रिपोर्ट" : "Doctor's Synthesis"}
                  </p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[12px] font-black text-emerald-400 uppercase tracking-widest">
                        {isHindi ? "नया अपडेट उपलब्ध" : "New AI Upgrade"}
                      </span>
                      <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                        Expert Clinical recalibration
                      </p>
                    </div>
                  </div>
                  <p className="text-[13px] font-bold text-white/90 leading-relaxed">
                    Get a more professional, empathetic, and doctor-like
                    clinical synthesis of your report.
                  </p>
                  <button
                    onClick={handleReanalyze}
                ...
                <div className="flex flex-col gap-2.5">
                  {aiAnalysis.keyFindings.slice(0, 4).map((finding, i) => (
                    <div key={i} className="flex items-start gap-3">
                      ...
                      <p className="text-[13px] text-[#2c3e50] font-bold leading-snug">
                        {t(finding)}
                      </p>
                    </div>
                  ))}
        ...
        {!isProcessing && aiAnalysis?.deficiencies?.length > 0 && (
          <div className="bg-white/60 backdrop-blur-xl rounded-[40px] p-6 shadow-[0_4px_25px_rgba(0,0,0,0.04)] border border-white">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-[20px] font-black text-[#1a2138] uppercase tracking-tight">
                {isHindi ? "कमियां पाई गईं" : "Critical Deficiencies"}
              </h2>
            </div>
            <div className="flex flex-col gap-4">
              {aiAnalysis.deficiencies.map((def, i) => (
                <div
                  key={i}
                  className="bg-white/80 rounded-[28px] p-5 border border-red-100 relative overflow-hidden"
                >
                  <div className="absolute top-0 left-0 w-1.5 h-full bg-[#EF4444]"></div>
                  <div className="flex justify-between items-start mb-4 pl-2">
                    <h3 className="text-[16px] font-black text-[#1a2138] uppercase tracking-tight">
                      {t(def.name)}
                    </h3>
                    <span className="bg-red-50 text-[#EF4444] text-[9px] font-black px-2.5 py-1 rounded-full uppercase tracking-widest border border-red-100">
                      {def.severity || "Caution"}
                    </span>
                  </div>
                  <div className="grid grid-cols-2 gap-3 pl-2">
                    <div className="bg-white/50 rounded-2xl p-3 border border-slate-50">
                      ...
                      <p className="text-base font-black text-[#1a2138]">
                        {def.currentValue || "N/A"}
                      </p>
                    </div>
                    <div className="bg-white/50 rounded-2xl p-3 border border-slate-50">
                      <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-1">
          ...
          <div className="bg-white/60 backdrop-blur-xl rounded-[40px] p-8 shadow-[0_4px_25px_rgba(0,0,0,0.04)] border border-white flex flex-col gap-6 group relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-[20px] font-black text-[#1a2138] uppercase tracking-tight">
                  {isHindi ? "व्यक्तिगत आहार योजना" : "Nutritional Protocol"}
                </h1>
              </div>
              ...
              >
                <Sparkles size={18} />
                {isHindi
                  ? "व्यक्तिगत आहार योजना जनरेट करें"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold tracking-tight">
                  {isHindi ? "डॉक्टर की सलाह" : "Doctor's Recommendations"}
                </h2>
            ...
            <div className="flex flex-col gap-4">
              {(aiAnalysis?.doctorAdvice && aiAnalysis.doctorAdvice.length > 0
                ...
                : aiAnalysis?.recommendations?.lifestyle &&
                  ...
                  ? aiAnalysis.recommendations.lifestyle.map((advice) =>
                      t(advice),
                    )
                  : [
                ...
                <div
                  key={idx}
                  className="bg-white/10 rounded-[32px] p-6 flex items-start gap-6 group hover:bg-white/15 transition-all relative overflow-hidden"
                >
                  ...
                  <p className="text-[15px] font-bold leading-snug relative z-10 pt-1.5">
                    {step}
                  </p>
                </div>
              ))}
        ...
        <div className="text-center px-4 pb-12">
          <p className="text-[11px] font-bold text-slate-400 leading-relaxed uppercase tracking-widest">
            Disclaimer: This AI analysis is for informational wellness support
            only and should not replace professional medical advice. Always
