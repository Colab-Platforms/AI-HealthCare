...
export default function ReportSummary() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#F2F5EC]">
        <div className="text-center">
          ...
          <p className="text-[#69A38D] font-black uppercase tracking-widest text-[10px]">
  ...
  if (!report)
    return (
      <div className="text-center py-20 bg-[#F2F5EC] min-h-screen font-black text-[#1a2138] uppercase">
        Analysis not found
      </div>
    );
      ...
      <div className="min-h-screen bg-[#F2F5EC] flex flex-col pt-16 px-6 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-8 relative z-10 text-center">
          ...
          <div className="bg-white/60 backdrop-blur-xl rounded-[40px] p-8 border border-white shadow-xl mt-8 w-full">
            ...
            <h3 className="text-lg font-black text-[#1a2138] mb-3 uppercase tracking-tight">
              While you wait...
            </h3>
  ...
  return (
    <div
      ...
      className="w-full min-h-screen bg-gradient-to-b from-[#F2F5EC] to-[#E5EBE0] dark:from-[#161719] dark:to-[#161719] pb-32 relative overflow-x-hidden animate-in fade-in duration-500"
    >
      <SEO pageName="reportSummary" />
      ...
      <div className="px-6 pt-12 pb-6 flex items-center justify-between sticky top-0 bg-[#F2F5EC]/80 dark:bg-[#161719]/80 backdrop-blur-md z-50 border-b border-white/50">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-[20px] font-black text-[#1a2138] dark:text-white tracking-tight leading-none uppercase">
            {isHindi ? "संक्षिप्त सारांश" : "Synthesis Summary"}
          </h1>
      ...
      <div className="px-6 flex flex-col gap-8 max-w-4xl mx-auto relative z-10 pt-4">
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-[40px] p-8 shadow-[0_8px_32px_rgba(0,0,0,0.04)] border border-white flex flex-col gap-8 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between relative z-10">
            <div className="flex items-center gap-5">
              <div className="w-20 h-20 rounded-[28px] bg-white shadow-lg border border-white flex flex-col items-center justify-center">
                <span className="text-[32px] font-black text-[#1a2138] leading-none tracking-tighter">
                  {aiAnalysis?.healthScore || "N/A"}
                </span>
                <span className="text-[8px] font-black text-[#69A38D] uppercase tracking-widest mt-1">
                  Score
                </span>
              </div>
              <div className="flex flex-col">
                <h2 className="text-[24px] font-black text-[#1a2138] leading-tight uppercase tracking-tight">
                  {report.reportType}
                </h2>
            ...
            <div className="hidden sm:flex flex-col items-end">
              ...
              <span className="text-[16px] font-black text-[#1a2138]">
          ...
          <div className="flex flex-col gap-5 relative z-10">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="text-[14px] font-black text-[#1a2138] uppercase tracking-widest">
                  {isHindi ? "डॉक्टर का विश्लेषण" : "Doctor's Analysis"}
                </h3>
                {!isProcessing && (
                  <p className="text-[9px] font-black text-[#69A38D] uppercase tracking-widest">
        ...
        {aiAnalysis?.keyFindings?.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {aiAnalysis.keyFindings.map((finding, idx) => (
              <div
                key={idx}
                className="bg-white/60 rounded-[32px] p-5 border border-white flex items-start gap-4 shadow-sm hover:bg-white/80 transition-all"
              >
                <div className="w-10 h-10 rounded-2xl bg-white shadow-sm flex items-center justify-center shrink-0 border border-slate-50">
                  <CheckCircle2
                    size={20}
                    className="text-[#69A38D]"
                    strokeWidth={2.5}
                  />
                </div>
                <p className="text-[13px] font-bold text-[#1a2138] leading-relaxed pt-1">
                  {t(finding)}
                </p>
              </div>
            ))}
        ...
        {metrics.length > 0 && (
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between px-2">
              <h2 className="text-[20px] font-black text-[#1a2138] leading-none uppercase tracking-tight">
                Core Bio-Markers
              </h2>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span
                        className={`text-[11px] font-black ${colorClass} uppercase tracking-widest`}
                      >
                        {metric.status}
                      </span>
                      <div className="w-1.5 h-1.5 rounded-full bg-slate-200 group-hover:bg-[#69A38D] transition-colors"></div>
                    </div>
                    <h4 className="text-[13px] font-black text-[#1a2138] uppercase tracking-tight leading-snug line-clamp-2">
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-[40px] p-8 shadow-[0_4px_25px_rgba(0,0,0,0.04)] border border-white flex flex-col gap-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-[20px] font-black text-[#1a2138] uppercase tracking-tight">
              {isHindi ? "पोषण प्रोटोकॉल" : "Nutritional Protocol"}
            </h2>
          </div>
          ...
          <div className="flex flex-col gap-4">
            {(aiAnalysis?.doctorAdvice && aiAnalysis.doctorAdvice.length > 0
              ...
              : aiAnalysis?.recommendations?.lifestyle &&
                ...
                : [
                    `Clinical follow-up for your ${report.reportType} biomarkers`,
                    "Monitor trends in your medical synthesis over time",
                    "Discuss these AI insights with a licensed medical professional",
                    "Maintain a nutrition profile specific to your laboratory findings",
                  ]
            ).map((step, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-sm font-black shrink-0 border border-white/20 shadow-sm relative z-10">
                  {idx + 1}
                </div>
        ...
        <div className="flex flex-col items-center gap-4 pb-20 text-center px-8">
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-relaxed">
            AI Summary is based on localized diagnostic synthesis. Results
            provided are for optimization support and verified bio-marker
            tracking. Record ID: {id.substring(0, 12)}
          </p>
          <div className="flex items-center gap-4">
            <div className="w-2 h-2 rounded-full bg-[#69A38D]"></div>
            <span className="text-[9px] font-black text-[#1a2138] uppercase tracking-[0.3em]">
              take.health AI Platform
            </span>
          </div>
        </div>
      </div>
