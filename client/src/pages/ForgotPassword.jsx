      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="w-full bg-white rounded-3xl p-2 sm:p-4">
          <button
            ...
            className="flex items-center gap-2 mb-3 text-[#064e3b] font-black uppercase tracking-tighter text-[9px] shrink-0"
          >
            ...
            <form onSubmit={handleSendCode} className="space-y-4">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <span className="text-base">Send Code</span>{" "}
          ...
          {step === 2 && (
            <form onSubmit={handleVerifyCode} className="space-y-6 text-center">
              <div className="space-y-4">
                ...
                <p className="text-center mt-4 text-gray-400 font-bold uppercase text-[9px] tracking-widest">
                  Didn't receive code?{" "}
                  <button
                    type="button"
                    onClick={handleSendCode}
                    className="text-[#064e3b] hover:text-[#042f24] transition-all border-b border-gray-200 hover:border-[#064e3b]"
                  >
                    Resend Code
                  </button>
                </p>
          ...
          <div className="mt-8 p-5 bg-gray-50 rounded-2xl border border-gray-100 relative overflow-hidden">
            <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest leading-relaxed">
              <span className="text-[#064e3b] uppercase tracking-tighter mr-1.5">
                Security Note:
              </span>
              take.health AI Platform never asks for your password over email.
              All password resets are handled through our secure verification
              system.
            </p>
          </div>
        </div>
