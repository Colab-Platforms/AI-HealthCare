              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-100">
                    <th className="text-left px-6 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                      User
                    </th>
                    <th className="text-left px-4 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest hidden md:table-cell">
                      Report Type
                    </th>
                    <th className="text-center px-4 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                      Health Score
                    </th>
                    <th className="text-center px-4 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                      Status
                    </th>
                    <th className="text-center px-4 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest hidden md:table-cell">
                      Date
                    </th>
                    <th className="text-center px-4 py-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                      Actions
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-sm font-semibold text-[#1a1a1a] truncate max-w-[140px]">
                                {r.user?.name || "Unknown"}
                              </p>
                        ...
                        <td className="px-4 py-4 text-center">
                          <span
                            className={`text-lg font-bold ${(r.aiAnalysis?.healthScore || 0) >= 70 ? "text-emerald-600" : (r.aiAnalysis?.healthScore || 0) >= 40 ? "text-amber-600" : "text-red-600"}`}
                          >
                        ...
                        <td className="px-4 py-4 text-center">
                          <span
                            className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase border ${badge.color}`}
                          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-slate-100">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="p-2 rounded-lg bg-slate-50 hover:bg-slate-100 disabled:opacity-40 transition-colors"
                >
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="p-3 bg-slate-50 rounded-xl">
                    ...
                    <p className="text-sm font-bold text-[#1a1a1a] capitalize mt-1">
                ...
                <div className="p-3 bg-slate-50 rounded-xl">
                  ...
                  <p className="text-sm font-medium text-[#1a1a1a] capitalize">
                    {selectedReport.reportType || "General Health Report"}
                  </p>
                </div>
