...
export default function AdminUsers() {
  ...
  const handleDeleteUser = async (userId, userName) => {
    if (
      !window.confirm(
        `CRITICAL ACTION: Are you sure you want to PERMANENTLY delete user "${userName}"? .`,
      )
    ) {
      return;
    }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">
            {total} total system identities recorded
          </p>
        </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-slate-400 italic lowercase">
                              {u.email}
                            </p>
                          </div>
                        </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden p-4 md:p-8">
            ...
            >
              <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
                ...
                <button
                  onClick={() => setUserDetail(null)}
                  className="p-2.5 hover:bg-white hover:shadow-md rounded-xl transition-all"
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-4 p-3.5 bg-slate-50 rounded-xl">
                      ...
                      <p className="text-xs font-bold text-slate-700">
                        {userDetail.phone || "No mobile linked"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div className="p-3 bg-white border border-slate-100 rounded-2xl shadow-sm">
                      ...
                      <p className="text-xs font-bold text-slate-700">
                        {userDetail.nutritionGoal?.goal || "General"}
                      </p>
                    </div>
                    <div className="p-3 bg-white border border-slate-100 rounded-2xl shadow-sm">
                      <p className="text-[8px] font-bold text-slate-400 uppercase mb-1">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.isDiabetic?.toUpperCase() ||
                              "NO"}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.allergies?.length
                              ? userDetail.profile.allergies.join(", ")
                              : "None"}
                          </span>
                        </div>
                        <div className="flex justify-between text-xs">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.chronicConditions?.length
                              ? userDetail.profile.chronicConditions.join(", ")
                              : "None"}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-xs">
                          ...
                          <span
                            className={`font-bold ${userDetail.isEmailVerified ? "text-emerald-600" : "text-amber-600"}`}
                          >
                    ...
                    <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.lifestyle?.sleepHours
                              ? `${userDetail.profile.lifestyle.sleepHours} hrs`
                              : "--"}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.lifestyle?.stressLevel?.toUpperCase() ||
                              "--"}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.lifestyle?.waterIntake
                              ? `${userDetail.profile.lifestyle.waterIntake} glasses`
                              : "--"}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.activityLevel
                              ?.replace("_", " ")
                              ?.toUpperCase() || "SEDENTARY"}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-slate-500">Cuisine:</span>
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.dietPreferences
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-slate-700">
                            {userDetail.profile?.dietaryPreference?.toUpperCase() ||
                              "--"}
                          </span>
                        </div>
                      </div>
