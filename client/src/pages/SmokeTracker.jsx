...
export default function SmokeTracker() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col w-full max-w-md mx-auto overflow-hidden font-roboto border-x border-white/40 relative"
      style={{ background: "linear-gradient(160deg, #f0fdf8 0%, #f7fef9 50%, #ecfdf5 100%)" }}
    >
      ...
      <header
        ...
        style={{
          background: "rgba(240,253,248,0.75)",
          backdropFilter: "blur(28px) saturate(180%)",
          borderBottom: "1px solid rgba(16,185,129,0.15)",
          boxShadow: "0 2px 16px rgba(16,185,129,0.06)",
        }}
      >
        <button onClick={() => navigate(-1)} className="liquid-glass-btn w-10 h-10 rounded-xl active:scale-90 transition-all flex items-center justify-center text-slate-700">
      ...
      <div className="flex-1 overflow-y-auto pb-24 p-5 space-y-6">
        ...
        {/* Main Logging Panel */}
        <div className="liquid-glass-strong rounded-[2.5rem] p-6 text-center relative overflow-hidden">
          ...
          <div className="flex items-center justify-center gap-8 mb-5">
            ...
            <button
              ...
              className="liquid-glass-inner w-12 h-12 rounded-2xl flex items-center justify-center disabled:opacity-20 active:scale-95 transition-all text-slate-500 hover:text-black"
            >
          ...
          <div className="border-t border-slate-100 pt-5 mt-4 flex flex-col items-center gap-3">
            <div className="flex items-center gap-1.5 text-emerald-700 text-xs font-black uppercase tracking-wider liquid-glass-pill px-4 py-2 rounded-full">
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {TRIGGERS.map((t) => {
                    ...
                    return (
                      <button
                        ...
                        className="liquid-glass-inner flex items-center gap-1.5 px-3 py-2 rounded-xl active:scale-95 transition-all"
                      >
                  ...
                  <button
                    ...
                    className="liquid-glass-inner px-3 py-2 rounded-xl text-[10px] font-black text-slate-500 uppercase tracking-wide"
                  >
                    Skip
                  </button>
                </div>
        ...
        {historyStats.topTrigger && (
          <div className="liquid-glass rounded-3xl p-5 flex items-start gap-4">
            ...
            <div className="flex-1 space-y-1">
              <span className="text-[9px] font-black uppercase tracking-wider text-amber-700">AI Pattern Predictor</span>
        ...
        <div className="liquid-glass rounded-[2rem] p-6 relative overflow-hidden">
