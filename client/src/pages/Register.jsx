...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (bmi < 10 || bmi > 80) {
      toast.error(
        "Height and weight combination seems physiologically improbable.",
      );
      return;
    }
      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="w-full rounded-3xl p-5 sm:p-6"
          ...
          <div className="mb-2 relative shrink-0">
            {step > 1 && (
              <button
                onClick={() => setStep(step - 0.5)}
                className="absolute -top-3 left-0 flex items-center gap-1 text-[#064e3b] font-black uppercase text-[8px] tracking-widest"
              >
          ...
          {step === 1 ? (
            <form onSubmit={handleNext} className="space-y-2">
              ...
              <div className="mt-4 text-center">
                ...
                <Link
                  to="/login"
                  className="ml-2 font-black text-[#064e3b] hover:text-[#042f24] transition-all uppercase text-xs tracking-widest border-b-2 border-gray-200 hover:border-[#064e3b] pb-0.5"
                >
                  Sign In
                </Link>
              </div>
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="space-y-1">
                <p className="text-[#064e3b] font-black text-lg uppercase tracking-tighter">
                  Enter Code
                </p>
                <p className="text-gray-400 font-bold text-[9px] uppercase tracking-widest">
                  Sent to{" "}
                  <span className="text-[#064e3b] px-2 py-0.5 bg-gray-50 rounded-lg">
                    {formData.email}
                  </span>
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  {loading ? (
                    ...
                    <span className="text-base">Confirm Identity</span>
                  )}
                </button>
                <button
                  ...
                  <div className="flex items-center justify-between mb-1 ml-1">
                    ...
                    <div className="flex bg-gray-100 rounded-lg p-0.5">
                      <button
                        ...
                        className={`px-2 py-0.5 text-[8px] font-black uppercase rounded-md transition-all ${heightUnit === "cm" ? "bg-[#064e3b] text-white shadow-sm" : "text-gray-400"}`}
                      >
                        cm
                      </button>
                      <button
                        ...
                        className={`px-2 py-0.5 text-[8px] font-black uppercase rounded-md transition-all ${heightUnit === "ft" ? "bg-[#064e3b] text-white shadow-sm" : "text-gray-400"}`}
                      >
                        ft
                      </button>
                    </div>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setFeet(f);
                          const totalCm =
                            parseFloat(f || 0) * 30.48 +
                            parseFloat(inches || 0) * 2.54;
                          setFormData({
                            ...formData,
                            height: totalCm.toFixed(1),
                          });
                        }}
                        className="w-1/2 bg-white border-2 border-gray-400 rounded-xl py-2.5 px-3 focus:outline-none focus:ring-4 focus:ring-[#064e3b]/10 focus:border-[#064e3b] text-gray-800 font-semibold transition-all text-base shadow-sm"
                        required
                      />
                      <input
                        type="number"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, isDiabetic: e.target.value })
                    }
                    className="w-full bg-white border-2 border-gray-400 rounded-xl py-2.5 px-4 focus:outline-none focus:ring-4 focus:ring-[#064e3b]/10 focus:border-[#064e3b] text-gray-800 font-semibold appearance-none transition-all text-base shadow-sm"
                    required
                  >
