              ...
              {activeAlerts.length > 0 ? (
                activeAlerts.slice(0, 3).map((alert) => (
                  ...
                  >
                    ...
                    <h4 className="text-sm font-bold truncate uppercase">
                      {alert.foodName}
                    </h4>
                  </button>
                ))
            ...
            {loading ? (
                ...
                <div className="flex-1 space-y-8">
                  ...
                  <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="h-4 w-full animate-shimmer rounded-full"
                      ></div>
                    ))}
                  </div>
              ...
              >
                <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedItem.adulterants?.map((a, i) => (
                        <span
                          key={i}
                          className="px-4 py-1.5 bg-red-50 text-red-600 border border-red-100 rounded-full text-[10px] font-black uppercase tracking-widest"
                        >
                          {a}
                        </span>
                      ))}
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <div
                      className={`text-5xl font-black ${selectedItem.safetyScore > 70 ? "text-emerald-500" : "text-red-500"}`}
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                  ...
                  <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden">
                    ...
                    <h4 className="text-xs font-black text-white uppercase tracking-widest mb-6 flex items-center gap-2">
                      <Beaker className="w-4 h-4 text-slate-400" /> Home Purity
                      Test
                    </h4>
                    <div className="space-y-6">
                      {selectedItem.homeTests?.map((test, i) => (
                        <div key={i} className="flex gap-4">
                          <div className="w-8 h-8 rounded-2xl bg-white/10 flex items-center justify-center text-xs font-black shrink-0">
                            {i + 1}
                          </div>
              ...
              >
                ...
                <h3 className="text-2xl font-black text-slate-900 uppercase mb-4 tracking-tight">
                  Search to Verify Safety
                </h3>
                <p className="text-slate-400 text-sm font-medium max-w-sm mx-auto leading-relaxed">
                  Enter any food item above to scan official records and learn
