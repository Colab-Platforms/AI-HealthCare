...
const timelineData = [
  {
    ...
    title: "AI Analysis",
    date: "Real-time",
    content: "Advanced AI-powered analysis of your medical reports to identify health patterns and risks.",
    category: "Feature",
    icon: Brain,
    relatedIds: [2, 3],
    status: "completed",
  ...
  },
  {
    ...
    date: "24/7",
    content: "Continuous monitoring of your health metrics with smart alerts and personalized recommendations.",
    category: "Feature",
    icon: Heart,
    relatedIds: [1, 4],
    status: "completed",
  ...
  },
  {
    ...
    date: "Verified",
    content: "Connect with verified healthcare professionals recommended based on your specific health needs.",
    category: "Feature",
    icon: Users,
    relatedIds: [1, 5],
    status: "completed",
  ...
  },
  {
    ...
    date: "Personalized",
    content: "Get customized nutrition plans and supplement recommendations based on your health profile.",
    category: "Feature",
    icon: Apple,
    relatedIds: [2, 5],
    status: "completed",
  ...
  },
  {
    ...
    title: "Report Upload",
    date: "Instant",
    content: "Upload your medical reports and get instant AI-powered analysis with actionable insights.",
    category: "Feature",
    icon: Upload,
    relatedIds: [3, 4],
    status: "completed",
