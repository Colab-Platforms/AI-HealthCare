    ...
    <section>
      <motion.div {...fadeIn} className="relative mt-24 z-0">
        ...
        <div className="absolute bottom-0 bg-gradient-to-t from-landing-primary to-transparent w-full h-64 z-50 flex items-end justify-center gap-5">
          <button className="bg-landing-secondary text-landing-text bg-landing-accent-bg font-landing-title text-xl py-2 px-6 rounded-full hover:bg-landing-tertiary transition-colors duration-300">
      ...
      <motion.div {...fadeIn} className="bg-landing-primary pt-14 z-50">
