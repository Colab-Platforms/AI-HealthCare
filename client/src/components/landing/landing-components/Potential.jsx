...
const Potential = () => {
  ...
  const potentialItems = [
    {
      ...
      description: "Get a comprehensive view of your overall wellness by tracking and correlating multiple health metrics simultaneously in one unified grid.",  
    ...
    },
    {
      ...
      description: "Decode complex laboratory results into easily understandable insights, highlighting core areas of focus for your long-term vitality.",  
    ...
    },
    {
      ...
      description: "Proactively identify subtle deviations in your health data to prevent potential issues before they develop into serious conditions.",  
    ...
    },
    {
      ...
      description: "Analyze your dietary and biomarker data to pinpoint exactly which essential vitamins and minerals your body might be lacking.",  
    ...
    },
    {
      ...
      description: "Receive dynamically adjusted nutritional recommendations based on your unique metabolic responses, goals, and lifestyle preferences.",  
    ...
    },
    {
      ...
      description: "Seamlessly integrate your daily movement and fluid intake, ensuring you meet fundamental physiological needs effortlessly.",  
  ...
  const circleItems = Array.from({ length: numItems }).map((_, i) => potentialItems[i % potentialItems.length]);
