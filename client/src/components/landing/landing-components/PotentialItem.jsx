...
const PotentialItem = ({ src, alt, title, subTitle, description }) => {
  ...
  return (
    <div 
      className="relative w-64 h-80 md:w-72 md:h-96 cursor-pointer group flex-shrink-0"
    ...
    >
      ...
      >
        ...
        >
          <h3 className="font-landing-title text-2xl font-semibold mb-3 text-[#4d867c]">{title}</h3>
