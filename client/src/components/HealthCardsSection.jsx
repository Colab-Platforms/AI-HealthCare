  ...
  return (
    <section className="py-20 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top Card - Full Width */}
        <div className="mb-8 rounded-[32px] bg-[#8B7355] overflow-hidden relative min-h-[500px] flex items-center justify-center">
          <div className="relative z-10 text-center px-8 py-16">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
              <Link
                to="/register"
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#8B7355] rounded-full font-medium hover:bg-[#F5F1EA] transition-all shadow-lg"
              >
                Get started
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Left Card - Tracking */}
          <div className="rounded-[32px] bg-[#8B7355] overflow-hidden relative min-h-[500px] p-8 md:p-12">
            {/* Glassmorphic Inner Card */}
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 h-full flex flex-col justify-between shadow-2xl">
              <div>
                <h3 className="text-3xl md:text-4xl font-serif text-white mb-4 leading-tight">
                  Track your health,
                  <br />
                  <span className="text-[#D4C5B0]">stay on track</span>
                </h3>
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 h-full flex flex-col justify-between shadow-2xl">
              <div>
                <h3 className="text-3xl md:text-4xl font-serif text-white mb-4 leading-tight">
                  Eat healthy,
                  <br />
                  <span className="text-[#D4C5B0]">get strong</span>
                </h3>
                <p className="text-white/90 text-base mb-6">
              ...
              <div className="mt-8 grid grid-cols-4 gap-2">
                {[...Array(8)].map((_, i) => (
                  <div
                    key={i}
                    className="aspect-square rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/10"
                  >
                    <Apple className="w-6 h-6 text-white/60" />
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="mt-8 rounded-[32px] bg-[#8B7355] overflow-hidden relative min-h-[400px] p-8 md:p-12">
          {/* Glassmorphic Inner Card */}
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            <div className="text-center max-w-3xl mx-auto">
              <h3 className="text-3xl md:text-5xl font-serif text-white mb-4 leading-tight">
                ...
                <br />
                <span className="text-[#D4C5B0]">it's personal</span>
              </h3>
