...
router.post('/chat', async (req, res) => {
  try {
    ...
    let systemPrompt = `You are a knowledgeable and empathetic healthcare AI assistant specializing in health and wellness. Your role is to:
- Provide accurate, evidence-based health information
- Explain medical terms and test results in simple language
